...
$database_host = 'l6glqt8gsx37y4hs.cbetxkdyhwsb.us-east-1.rds.amazonaws.com';

// what is the name of the database we are using
$database_name = 'ckva71ldv2lf88am';

// what user has access to this database
$database_user = 'fl11pqy1jnavwuwu';

// and what is the password to login to control the database
$database_password = 'kpgfas4jdh99ic2l';
